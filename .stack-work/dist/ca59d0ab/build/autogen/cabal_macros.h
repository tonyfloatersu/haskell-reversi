...
/* package haskell-reversi-0.1.0.0 */
#define VERSION_haskell_reversi "0.1.0.0"
#define MIN_VERSION_haskell_reversi(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
...
#define CURRENT_COMPONENT_ID "haskell-reversi-0.1.0.0"

#define CURRENT_PACKAGE_KEY "haskell-reversi-0.1.0.0"
